...
class TenantBuildingListPage extends StatefulWidget {
  ...
  @override
  State<TenantBuildingListPage> createState() =>
      _TenantBuildingListePageState();
}

class _TenantBuildingListePageState extends State<TenantBuildingListPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Tenant Building List'),
      ),
      body: Center(
        child: Text('This is a placeholder for Tenant Building List Page'),
      ),
    );
  }
}
